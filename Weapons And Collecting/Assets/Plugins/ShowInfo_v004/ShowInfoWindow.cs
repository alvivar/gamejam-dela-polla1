...
public class ShowInfoWindow : EditorWindow
{
    ...
    public static int defaultSpaceBefore = 5;
    public static int defaultHeight = -6;
    public static int defaultSpaceAfter = 6;
    public static int defaultWidth = 35;
    public static int defaultInnerWidth = 5;
    public static TextAnchor defaultAnchor = TextAnchor.MiddleCenter;
    public static FontStyle defaultStyle = FontStyle.Bold;
    public static Object font;
    public static int defaultSize = 10;
    public static bool boxEnabled = true;
    public static ShowInfoColor defaultColor = ShowInfoColor.White;
    public static ShowInfoColor defaultBoxColor = ShowInfoColor.Black;
    ...
    void OnGUI()
    {
        ...
        font = EditorGUILayout.ObjectField(font, typeof(Font), false);
    ...
    {
        defaultSpaceBefore = EditorPrefs.GetInt("StoredDefault_SpaceBefore", 5);
        defaultHeight = EditorPrefs.GetInt("StoredDefault_Height", -6);
        defaultSpaceAfter = EditorPrefs.GetInt("StoredDefault_SpaceAfter", 6);
        defaultWidth = EditorPrefs.GetInt("StoredDefault_Width", 35);
        defaultInnerWidth = EditorPrefs.GetInt("StoredDefault_InnerWidth", 5);

        ///

        defaultAnchor = (TextAnchor)System.Enum.Parse(typeof(TextAnchor),
            EditorPrefs.GetString("StoredDefault_Anchor", "MiddleCenter"));

        defaultStyle = (FontStyle)System.Enum.Parse(typeof(FontStyle),
            EditorPrefs.GetString("StoredDefault_Style", "Bold"));

        defaultSize = EditorPrefs.GetInt("StoredDefault_Size", 10);

        boxEnabled = EditorPrefs.GetBool("StoredDefault_Box", true);

        defaultColor = (ShowInfoColor)System.Enum.Parse(typeof(ShowInfoColor),
            EditorPrefs.GetString("StoredDefault_FontColor", "White"));

        defaultBoxColor = (ShowInfoColor)System.Enum.Parse(typeof(ShowInfoColor),
            EditorPrefs.GetString("StoredDefault_BoxColor", "Black"));
