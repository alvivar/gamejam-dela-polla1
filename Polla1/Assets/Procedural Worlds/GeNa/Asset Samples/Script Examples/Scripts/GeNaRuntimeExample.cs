using UnityEngine;
// Include the GeNa Core namespace
using GeNa.Core;
/// <summary>
...
public class GeNaRuntimeExample : MonoBehaviour
{
    ...
    public Constants.SpawnRangeShape spawnShape = Constants.SpawnRangeShape.Circle; // Spawn Range Shape - Circle, Square
    ...
    private void SplineSpawn()
    {
        ...
        if (splineNodes == null)
            return; // Exit method
        // Create a new Spline
        GeNaSpline spline = GeNaSpline.CreateSpline("GeNa Spline");
